...
const selectedChannelCurrency = computed(() => String(appStore.config?.currency || 'USD'))
...
const balanceDisplay = computed(() => formatMoney(wallet.value?.balance, String(appStore.config?.currency || 'USD')))
